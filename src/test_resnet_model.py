...
# MODEL_PATH = os.path.join(PROJECT_ROOT, "models", "resnet18.pth")
MODEL_PATH = os.path.join(PROJECT_ROOT, "models", "resnet50_best_1.pth")
...
model = resnet18(pretrained=False)  # Load model structure
model.fc = torch.nn.Linear(512, 2)  # Modify last layer for binary classification
